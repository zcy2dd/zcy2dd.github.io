---
layout: post
title:  'Flink DataStream—— 状态(State)&检查点(Checkpoint)&保存点(Savepoint)原理'
date:  2021-4-22
tags: Flink
color: 'rgb(167,111,165)'
subtitle: '介绍了状态、检查点、保存点原理'
cover: 'https://blog-1253533258.cos.ap-shanghai.myqcloud.com/pic20210422143549.png'
---
